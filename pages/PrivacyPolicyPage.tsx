    ...
    <PageShell title="Datenschutzerklärung">
       <div className="max-w-4xl mx-auto py-12">
        ...
        <div className="mt-16 text-brand-muted space-y-12 text-left leading-relaxed">
            ...
            <div>
                <h2 className="text-2xl font-bold font-heading text-brand-dark uppercase tracking-wider border-b border-brand-dark/10 pb-4 mb-6">Hosting & Serverlogs</h2>
                <p className="text-lg">
            ...
            <div>
                ...
                <div className="bg-brand-surface/60 p-6 rounded-lg border border-brand-dark/10">
                    <p className="font-bold text-brand-dark mb-2 uppercase text-sm tracking-wider">Verarbeitung durch n8n</p>
                    <p className="text-sm">
            ...
            <div>
                <h2 className="text-2xl font-bold font-heading text-brand-dark uppercase tracking-wider border-b border-brand-dark/10 pb-4 mb-6">Lokale Schriftarten</h2>
                <p className="text-lg">
