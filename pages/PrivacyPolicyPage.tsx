  ...
  return (
    <PageShell title="Datenschutzerklärung">
      <div className="max-w-4xl mx-auto prose lg:prose-lg">
        ...
        <h2>Name und Anschrift des Verantwortlichen im Sinne Art. 4 DSGVO:</h2>
        <p>
          A+ Urban Design<br />
          Talstrasse 41<br />
          70188 Stuttgart<br />
        ...
        <h2>Verwendung von Scriptbibliotheken und Webfonts</h2>
        <p>
        ...
        <h2>Vorbehalt von Änderungen</h2>
        <p>
        ...
        <h2>Ihre Rechte auf Auskunft, Berichtigung, Sperre, Widerspruch, Löschung</h2>
        <p>
