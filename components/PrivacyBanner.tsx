...
const PrivacyBanner: React.FC = () => {
    ...
    return (
        <>
            {/* Main Banner */}
            <div className="fixed bottom-0 left-0 right-0 bg-brand-surface/95 backdrop-blur-sm p-6 border-t border-white/10 z-50 animate-[fade-in-up_0.5s_ease-out]">
            ...
            {isModalOpen && (
                 <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-[60] animate-[fade-in-up_0.3s_ease-out]">
                    <div className="bg-brand-surface rounded-lg shadow-2xl w-full max-w-lg m-4">
                        <div className="p-6 border-b border-white/10">
                            <h2 className="text-xl font-bold text-brand-heading">Datenschutz-Einstellungen</h2>
                        ...
                        <div className="p-6 space-y-4">
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <div className="relative inline-block w-10 ml-2 align-middle select-none">
                                    <input type="checkbox" checked readOnly className="checked:bg-brand-orange outline-none focus:outline-none right-4 checked:right-0 duration-200 ease-in absolute block w-6 h-6 rounded-full bg-gray-600 border-4 appearance-none cursor-not-allowed"/>
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <div onClick={() => togglePreference('analytics')} className="relative inline-block w-10 ml-2 align-middle select-none cursor-pointer">
                                    <input type="checkbox" checked={preferences.analytics} onChange={() => {}} className={`${preferences.analytics ? 'right-0 bg-brand-orange' : 'right-4 bg-gray-600'} outline-none focus:outline-none duration-200 ease-in absolute block w-6 h-6 rounded-full border-4 appearance-none`}/>
                                    <label className="block overflow-hidden h-6 rounded-full bg-gray-800"></label>
                                </div>
                            </div>
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <div onClick={() => togglePreference('marketing')} className="relative inline-block w-10 ml-2 align-middle select-none cursor-pointer">
                                    <input type="checkbox" checked={preferences.marketing} onChange={() => {}} className={`${preferences.marketing ? 'right-0 bg-brand-orange' : 'right-4 bg-gray-600'} outline-none focus:outline-none duration-200 ease-in absolute block w-6 h-6 rounded-full border-4 appearance-none`}/>
                                    <label className="block overflow-hidden h-6 rounded-full bg-gray-800"></label>
                                </div>
                            </div>
                        </div>
