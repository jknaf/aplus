  ...
  return (
    <PageShell title="Planung & Bau von Beton-Skateanlagen">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
        <div>
          <img loading="lazy" decoding="async" src="https://images.pexels.com/photos/4167333/pexels-photo-4167333.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&fit=crop" alt="Moderner Beton-Skatepark mit diversen Skate-Elementen" className="w-full h-auto object-cover rounded-lg shadow-lg" />
          ...
          <div className="mt-10">
           ...
           <div className="mt-10">
            ...
            <ul className="mt-6 space-y-4 text-brand-muted">
              <li className="flex items-start"><span className="text-brand-orange mr-3 mt-1">&#10003;</span> <span className="font-bold mr-2">Fundamentfrei:</span> Schneller, kostengünstiger Aufbau.</li>
              <li className="flex items-start"><span className="text-brand-orange mr-3 mt-1">&#10003;</span> <span className="font-bold mr-2">Modular:</span> Jederzeit erweiter- und versetzbar.</li>
              <li className="flex items-start"><span className="text-brand-orange mr-3 mt-1">&#10003;</span> <span className="font-bold mr-2">Vandalismussicher:</span> Extrem robust gegen Beschädigung und Feuer.</li>
               <li className="flex items-start"><span className="text-brand-orange mr-3 mt-1">&#10003;</span> <span className="font-bold mr-2">Wartungsarm:</span> Kein Verrotten, keine losen Schrauben.</li>
            </ul>
          </div>
