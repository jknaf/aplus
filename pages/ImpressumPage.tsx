      ...
      <div className="max-w-4xl mx-auto py-12">
         <div className="text-center mb-24">
            ...
            <h1 className="text-5xl md:text-7xl font-extrabold font-heading text-brand-dark uppercase tracking-tighter leading-none">
                Impres<span className="text-brand-orange">sum.</span>
            </h1>
         </div>

        <div className="mt-16 text-brand-muted space-y-12">
            <div>
              <h2 className="text-2xl font-bold font-heading text-brand-dark uppercase tracking-wider border-b border-brand-dark/10 pb-4 mb-6">A+ URBAN DESIGN</h2>
            ...
            <div>
              <h2 className="text-2xl font-bold font-heading text-brand-dark uppercase tracking-wider border-b border-brand-dark/10 pb-4 mb-6">Kontakt</h2>
              <p className="text-lg leading-relaxed">
            ...
            <div>
              <h2 className="text-2xl font-bold font-heading text-brand-dark uppercase tracking-wider border-b border-brand-dark/10 pb-4 mb-6">Umsatzsteuer-ID</h2>
              <p className="text-lg leading-relaxed">
                Umsatzsteuer-Identifikationsnummer gemäß § 27 a Umsatzsteuergesetz:<br />
                <strong className="text-brand-dark">DE243482047</strong>
              </p>
            </div>

            <div>
              <h2 className="text-2xl font-bold font-heading text-brand-dark uppercase tracking-wider border-b border-brand-dark/10 pb-4 mb-6">Verantwortlich für den Inhalt</h2>
              <p className="text-lg leading-relaxed">
            ...
            <div>
              <h2 className="text-2xl font-bold font-heading text-brand-dark uppercase tracking-wider border-b border-brand-dark/10 pb-4 mb-6">Rechtliche Hinweise</h2>
              <p className="text-lg leading-relaxed">
